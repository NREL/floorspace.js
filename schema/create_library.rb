...
window_definitions << {:id => "", :name => "Multiple Window A", :window_definition_type => "Multiple Windows", :wwr => nil, :sill_height => 3, :window_spacing => 6, :height => 4, :width => 2, :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Multiple Window B", :window_definition_type => "Multiple Windows", :wwr => nil, :sill_height => 3, :window_spacing => 6, :height => 4, :width => 3, :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Multiple Window C", :window_definition_type => "Multiple Windows", :wwr => nil, :sill_height => 3, :window_spacing => 6, :height => 4, :width => 4, :overhang_projection_factor => nil, :fin_projection_factor => nil}
