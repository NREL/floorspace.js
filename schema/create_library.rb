...
window_definitions << {:id => "", :name => "Window A", :window_definition_mode => "Single Window", :wwr => nil, :sill_height => 3, :window_spacing => nil, :height => 4, :width => 2, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Window B", :window_definition_mode => "Single Window", :wwr => nil, :sill_height => 3, :window_spacing => nil, :height => 4, :width => 3, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Window C", :window_definition_mode => "Single Window", :wwr => nil, :sill_height => 3, :window_spacing => nil, :height => 4, :width => 4, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Repeating Window A", :window_definition_mode => "Repeating Windows", :wwr => nil, :sill_height => 3, :window_spacing => 6, :height => 4, :width => 2, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Repeating Window B", :window_definition_mode => "Repeating Windows", :wwr => nil, :sill_height => 3, :window_spacing => 6, :height => 4, :width => 3, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "Repeating Window C", :window_definition_mode => "Repeating Windows", :wwr => nil, :sill_height => 3, :window_spacing => 6, :height => 4, :width => 4, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "30% WWR", :window_definition_mode => "Window to Wall Ratio", :wwr => 0.3, :sill_height => 3, :window_spacing => 6, :height => nil, :width => nil, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
window_definitions << {:id => "", :name => "40% WWR", :window_definition_mode => "Window to Wall Ratio", :wwr => 0.4, :sill_height => 3, :window_spacing => 6, :height => nil, :width => nil, :window_type => "Fixed", :overhang_projection_factor => nil, :fin_projection_factor => nil}
