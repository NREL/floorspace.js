...
export default {
  computed: {
    ...
    showInstanceEditor() {
      return (
        this.instanceType &&
        this.currentComponent.type.replace(/_definitions$/, "s") ===
          this.instanceType
      );
    },
  },
  methods: {
    destroyComponent() {
      if (this.instanceType === "windows") {
        ...
        this.$store.dispatch("models/destroyDoor", {
          story_id: this.currentStory.id,
          object: this.componentInstance,
        });
      } else {
    ...
    modifyComponentInstance(id, key, value) {
      if (this.instanceType === "windows") {
        ...
        this.$store.dispatch("models/modifyDoor", {
          id,
          key,
          value,
          story_id: this.currentStory.id,
